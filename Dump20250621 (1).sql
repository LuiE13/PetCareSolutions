...
--
-- Dumping data for table `alimentador`
--

LOCK TABLES `alimentador` WRITE;
/*!40000 ALTER TABLE `alimentador` DISABLE KEYS */;
/*!40000 ALTER TABLE `alimentador` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `chatperguntas`
--

LOCK TABLES `chatperguntas` WRITE;
/*!40000 ALTER TABLE `chatperguntas` DISABLE KEYS */;
/*!40000 ALTER TABLE `chatperguntas` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-06-21 18:32:18
